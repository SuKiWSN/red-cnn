...
from networks import RED_CNN, DeeplabV3plusTransformer, L1Net, DilationNet, Class1
...
class Solver(object):
    def __init__(self, args, data_loader):
        ...
        # self.REDCNN = RED_CNN()
        # self.REDCNN = DeeplabV3plusTransformer(1024, 12)
        self.REDCNN = L1Net(1, 64, 3)
        # self.REDCNN = DilationNet(1, 96)
    ...
    def test(self):
        # load
        del self.REDCNN
        # self.REDCNN = L1Net(1, 64, 1).to(self.device)
        self.REDCNN = L1Net(1, 64, 3).to(self.device)
